...
Finally, most of the results do not show statistical significance. The exceptions are the results on the second treatment for the years 2017 and 2019, with coefficients of -0.107406 and -0.110650, respectively.

Thus, the results do not show systematical evidences that the AFS expansion reduced the deforestation on the Amazon and Cerrado biomes.
